#pragma once
#include "EmptyToBoolConverter.g.h"

namespace winrt::FluentChat::implementation
{
    struct EmptyToBoolConverter : EmptyToBoolConverterT<EmptyToBoolConverter>
    {
        EmptyToBoolConverter() = default;
...
{
    struct EmptyToBoolConverter : EmptyToBoolConverterT<EmptyToBoolConverter, implementation::EmptyToBoolConverter>
    {
    };
}
